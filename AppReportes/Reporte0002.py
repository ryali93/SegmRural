...
def Reporte0002Rural(provincias, WorkSpace, LIMITE_PRO, EscudoNacional, LogoInei):
    ...
    for prov in provincias:
        for provincia in [x for x in arcpy.da.SearchCursor(LIMITE_PRO, ["CCDD", "NOMBDEP", "CCPP", "NOMBPROV", 'CODPROV'], "CODPROV = '{}'".format(prov))]:
            ...
            Filas2 = [
                [Paragraph(u"<strong>N°</strong>", h3), Paragraph(u"<strong>Distrito</strong>", h3), Paragraph(u"<strong>Ubigeo</strong>", h3), Paragraph(u"<strong>N° de Comunidades<br/>Campesinas</strong>", h3), Paragraph(u"<strong>N° de Comunidades<br/>Nativas</strong>", h3), Paragraph(u"<strong>N° de Centros Poblados</strong>", h3), Paragraph(u"<strong>N° de Viviendas</strong>", h3)],
                [Paragraph(u"<strong>Total Provincial</strong>", h3), '', Paragraph(u"{}".format(totalubigeos), h3), Paragraph(u"{}".format(totalcc), h3), Paragraph(u"{}".format(totalcn), h3), Paragraph(u"{}".format(cantccpp), h3), Paragraph(u"{}".format(cantviv), h3)]
            ]
            Tabla2 = Table(Filas2,
                           colWidths=[1 * cm, 5 * cm, 3 * cm, 3 * cm, 3 * cm, 2.5 * cm, 2.5 * cm],
                           )
            ...
            for row in datos:
                ...
                Filas3 = [
                    [u'{}'.format(nreg), Paragraph(u'{}'.format(nombdist), h3), u'{}'.format(codubigeo), u'{}'.format(cc), u'{}'.format(cn), u'{}'.format(ccpp), u'{}'.format(vivccpp)]]
